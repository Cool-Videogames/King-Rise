export default class Boot extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('trampaOsos', "./phasertemplate-master/images/TrampaOsos/TrampaOsos.png");
    ...
    this.load.image('mina', "./phasertemplate-master/images/Estructuras/Mina.png");
